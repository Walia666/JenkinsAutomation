         ...
         for i in range(len(projects)):
                ...
                for issue in issues_in_proj:
                        ...
                        if str(issueobj.fields.status)=="Approved for ITE":
                                ...
                                print issueobj.key
                                if ft is not None and rt is not None and svn_branch is not None and (issue.key=="LOG-157" or issue.key=="LOG-158"):
...
def sendnotification(emaillist,issue_name,message):
                ...
                msg['From'] = email_user
                msg['To'] = "anshul.walia@shopclues.com"
                msg['Subject'] = subject
                body =  """ 
                 <html> 
                 <body>
